...
def who_starts():
    global starts
    print(
        "Tic Tac Toe game :) Do you want X or O? Type '1' for X, '2' for O and press enter"
    )
...
def choosing_field(starting):
    ...
    def check_win(board):
        ...
        for i in numpy.arange(0, 3):
            if all(
                x == "X" for x in values[i::3]
            ):  # start:stop:step i::3 is start from i end empty step 3
                print("X wins!")
                board1 = {
                    "1": " ","2": " ","3": " ",
                    "4": " ","5": " ","6": " ",
        ...
        if all(
            values[x] == "X" for x in diagonal1
        ):  # if I dont write =='X' it will check if field is empty only
            print("X wins!")
            board1 = {
                "1": " ","2": " ","3": " ",
                "4": " ","5": " ","6": " ",
